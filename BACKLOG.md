...
- **[HOOKS]** Improve lessons lifecycle — reduce noise, surface smarter (`improve-lessons-lifecycle`)
    ...
    - **progress**: P1-a done in v2.63.5 — `git` tag keywords narrowed to hazard-scenario words (`rebase,cherry-pick,force-push,reset,--force,--no-verify,--amend`), eliminating the substring-match that fired on 76% of tool calls. Remaining sub-pieces from `output/claude-toolkit/analysis/20260423_2309__analyze-idea__improve-lessons-lifecycle.md`: P0-a (intra-session dedup), P0-b (2+ keyword-hit threshold), pruning work.
