...
- **User owns shared-state ops**: Claude does not merge to main, push, or push tags. Wrap-up ends at the handoff. When the user merges, they use `git merge --no-ff` to preserve branch history.
