...
Write the PR description to `output/claude-toolkit/pr-descriptions/{timestamp}_{branch-name}.md` (e.g., `20260320_feat-add-auth.md`). Include the PR title as an H1 heading at the top of the file.
