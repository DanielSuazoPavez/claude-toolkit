...
1. [How This Works](#how-this-works) - Usage guidance
2. [Framing Block](#framing-block) - Expectation-setting opener
3. [Core Sections](#core-sections) - 8 backbone sections
   - [1. Project Context](#1-project-context) | [2. Tech Stack](#2-tech-stack) | [3. Architecture](#3-architecture) | [4. Configuration & Validation](#4-configuration--validation)
   - [5. Development Standards](#5-development-standards) | [6. Risks & Technical Decisions](#6-risks--technical-decisions) | [7. Team & Resources](#7-team--resources) | [8. References](#8-references)
4. [Contextual Sections](#contextual-sections) - 9 audience-driven sections (A–I)
5. [Status Markers](#status-markers) - In-progress tracking
6. [Section Ordering](#section-ordering) - Placement guidance
