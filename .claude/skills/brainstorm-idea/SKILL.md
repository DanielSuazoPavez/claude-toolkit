...
**See also:** `/brainstorm-feature` (when the goal is a software design document), `/analyze-idea` (for research/evidence gathering), `/review-plan` (to review decisions after brainstorming)
...
- **Goal is a software design** → `/brainstorm-feature`
...
**Escape hatch:** If the brainstorm has clearly become "what should I build", suggest switching to `/brainstorm-feature`.
