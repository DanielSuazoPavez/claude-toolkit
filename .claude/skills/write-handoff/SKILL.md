...
`.claude/output/sessions/{YYYYMMDD}_{HHMM}__write-handoff__{context}.md` - self-contained file to restore context after `/clear`.
...
Create `.claude/output/sessions/{YYYYMMDD}_{HHMM}__write-handoff__{context}.md` with this structure (use branch name or topic as context slug):
...
2. Write the file to `.claude/output/sessions/{YYYYMMDD}_{HHMM}__write-handoff__{context}.md`
...
- [ ] **File path correct?** `.claude/output/sessions/{YYYYMMDD}_{HHMM}__write-handoff__{context}.md`
