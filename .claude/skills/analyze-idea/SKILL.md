...
5. **Save report**:
   - Path: `.claude/output/analysis/{YYYYMMDD}_{HHMM}__analyze-idea__{topic}.md`
   ...
   - Example: `.claude/output/analysis/20260121_1430__analyze-idea__test-coverage-gaps.md`
