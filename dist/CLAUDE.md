...
|---------|--------|--------|--------|
| "Capture lessons" convention | Present | Omitted | Lessons system not synced to raiz yet — pending stabilization |
...
- 3 memories (code style, memory conventions, permissions config)

## When Editing Templates

- Changes to shared conventions (e.g., "Plan before building") go in **both** templates
